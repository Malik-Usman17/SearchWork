...
export const { setJobPost, login, isRememberMe, saveUserCredential, getJobCategory, getJobList, getViewJob, getSaveJobList, getApplicantsList, getProfile } = slices.actions;
